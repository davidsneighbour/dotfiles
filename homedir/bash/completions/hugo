...
__hugo_handle_flag()
{
    ...
    if __hugo_contains_word "${words[c]}" "${two_word_flags[@]}"; then
        c=$((c+1))
...
__hugo_handle_word()
{
    ...
    if [[ "${words[c]}" == -* ]]; then
        ...
        __hugo_handle_command
    elif [[ $c -eq 0 ]] && __hugo_contains_word "$(basename "${words[c]}")" "${commands[@]}"; then
        __hugo_handle_command
    else
        __hugo_handle_noun
    fi
...
_hugo_benchmark()
{
    ...
    flags_completion+=("__benchmark_handle_subdirs_in_dir_flag themes")
    two_word_flags+=("-t")
    ...
    flags_completion+=("__benchmark_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--debug")
    flags+=("--log")
    flags+=("--logFile=")
...
_hugo_config()
{
    ...
    flags+=("--config=")
    flags_with_completion+=("--config")
    flags_completion+=("__config_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--debug")
    flags+=("--log")
    flags+=("--logFile=")
    flags_with_completion+=("--logFile")
...
_hugo_convert_toJSON()
{
    ...
    flags+=("--config=")
    flags_with_completion+=("--config")
    flags_completion+=("__toJSON_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--debug")
    flags+=("--log")
    flags+=("--logFile=")
    flags_with_completion+=("--logFile")
...
_hugo_convert_toTOML()
{
    ...
    flags+=("--config=")
    flags_with_completion+=("--config")
    flags_completion+=("__toTOML_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--debug")
    flags+=("--log")
    flags+=("--logFile=")
    flags_with_completion+=("--logFile")
...
_hugo_convert_toYAML()
{
    ...
    flags+=("--config=")
    flags_with_completion+=("--config")
    flags_completion+=("__toYAML_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--debug")
    flags+=("--log")
    flags+=("--logFile=")
    flags_with_completion+=("--logFile")
...
_hugo_convert()
{
    ...
    flags+=("--config=")
    flags_with_completion+=("--config")
    flags_completion+=("__convert_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--debug")
    flags+=("--log")
    flags+=("--logFile=")
    flags_with_completion+=("--logFile")
...
_hugo_env()
{
    ...
    flags+=("--config=")
    flags_with_completion+=("--config")
    flags_completion+=("__env_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--debug")
    flags+=("--log")
    flags+=("--logFile=")
    flags_with_completion+=("--logFile")
...
_hugo_gen_autocomplete()
{
    ...
    flags+=("--config=")
    flags_with_completion+=("--config")
    flags_completion+=("__autocomplete_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--debug")
    flags+=("--log")
    flags+=("--logFile=")
    flags_with_completion+=("--logFile")
...
_hugo_gen_chromastyles()
{
    ...
    flags+=("--config=")
    flags_with_completion+=("--config")
    flags_completion+=("__chromastyles_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--debug")
    flags+=("--log")
    flags+=("--logFile=")
    flags_with_completion+=("--logFile")
...
_hugo_gen_doc()
{
    ...
    flags+=("--config=")
    flags_with_completion+=("--config")
    flags_completion+=("__doc_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--debug")
    flags+=("--log")
    flags+=("--logFile=")
    flags_with_completion+=("--logFile")
...
_hugo_gen_man()
{
    ...
    flags+=("--config=")
    flags_with_completion+=("--config")
    flags_completion+=("__man_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--debug")
    flags+=("--log")
    flags+=("--logFile=")
    flags_with_completion+=("--logFile")
...
_hugo_gen()
{
    ...
    flags+=("--config=")
    flags_with_completion+=("--config")
    flags_completion+=("__gen_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--debug")
    flags+=("--log")
    flags+=("--logFile=")
    flags_with_completion+=("--logFile")
...
_hugo_import_jekyll()
{
    ...
    flags+=("--config=")
    flags_with_completion+=("--config")
    flags_completion+=("__jekyll_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--debug")
    flags+=("--log")
    flags+=("--logFile=")
    flags_with_completion+=("--logFile")
...
_hugo_import()
{
    ...
    flags+=("--config=")
    flags_with_completion+=("--config")
    flags_completion+=("__import_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--debug")
    flags+=("--log")
    flags+=("--logFile=")
    flags_with_completion+=("--logFile")
...
_hugo_list_drafts()
{
    ...
    flags+=("--config=")
    flags_with_completion+=("--config")
    flags_completion+=("__drafts_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--debug")
    flags+=("--log")
    flags+=("--logFile=")
    flags_with_completion+=("--logFile")
...
_hugo_list_expired()
{
    ...
    flags+=("--config=")
    flags_with_completion+=("--config")
    flags_completion+=("__expired_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--debug")
    flags+=("--log")
    flags+=("--logFile=")
    flags_with_completion+=("--logFile")
...
_hugo_list_future()
{
    ...
    flags+=("--config=")
    flags_with_completion+=("--config")
    flags_completion+=("__future_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--debug")
    flags+=("--log")
    flags+=("--logFile=")
    flags_with_completion+=("--logFile")
...
_hugo_list()
{
    ...
    flags+=("--config=")
    flags_with_completion+=("--config")
    flags_completion+=("__list_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--debug")
    flags+=("--log")
    flags+=("--logFile=")
    flags_with_completion+=("--logFile")
...
_hugo_new_site()
{
    ...
    flags+=("--config=")
    flags_with_completion+=("--config")
    flags_completion+=("__site_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--debug")
    flags+=("--log")
    flags+=("--logFile=")
    flags_with_completion+=("--logFile")
...
_hugo_new_theme()
{
    ...
    flags+=("--config=")
    flags_with_completion+=("--config")
    flags_completion+=("__theme_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--debug")
    flags+=("--log")
    flags+=("--logFile=")
    flags_with_completion+=("--logFile")
...
_hugo_new()
{
    ...
    flags+=("--config=")
    flags_with_completion+=("--config")
    flags_completion+=("__new_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--debug")
    flags+=("--log")
    flags+=("--logFile=")
    flags_with_completion+=("--logFile")
...
_hugo_server()
{
    ...
    flags+=("--theme=")
    flags_with_completion+=("--theme")
    flags_completion+=("__server_handle_subdirs_in_dir_flag themes")
    two_word_flags+=("-t")
    flags_with_completion+=("-t")
    flags_completion+=("__server_handle_subdirs_in_dir_flag themes")
    local_nonpersistent_flags+=("--theme=")
    ...
    flags+=("--config=")
    flags_with_completion+=("--config")
    flags_completion+=("__server_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--debug")
    flags+=("--log")
    flags+=("--logFile=")
    flags_with_completion+=("--logFile")
...
_hugo_version()
{
    ...
    flags+=("--config=")
    flags_with_completion+=("--config")
    flags_completion+=("__version_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--debug")
    flags+=("--log")
    flags+=("--logFile=")
    flags_with_completion+=("--logFile")
...
_hugo()
{
    ...
    flags+=("--config=")
    flags_with_completion+=("--config")
    flags_completion+=("__hugo_handle_filename_extension_flag json|js|yaml|yml|toml|tml")
    flags+=("--contentDir=")
    two_word_flags+=("-c")
    local_nonpersistent_flags+=("--contentDir=")
    flags+=("--debug")
