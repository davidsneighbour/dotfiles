...
sudo apt install ack apt-transport-https arp-scan barrier bsdmainutils kitty \
  ...
  qt5ct rename shutter shc smartmontools software-properties-common rofi \
  texlive-extra-utils testdisk ubuntu-restricted-extras vim wget zoxide fzf w3m w3m-img chafa -y
sudo apt upgrade -y
