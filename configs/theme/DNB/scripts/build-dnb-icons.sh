...
Options:
  --source-dir PATH   Theme source directory.
                      Default: ${HOME}/github.com/davidsneighbour/dotfiles/configs/theme/DNB
...
Examples:
  ...
  $(basename "$0") --source-dir ${HOME}/github.com/davidsneighbour/dotfiles/configs/theme/DNB
EOF
}
...
source_dir="${HOME}/github.com/davidsneighbour/dotfiles/configs/theme/DNB"
sizes_csv="16,24,32,48,64,128"
verbose="false"
